...
Um dies umzusetzen wird eine künstliche Intelligenz entwickelt, genauer gesagt ein neuronales Netz. Die Testdaten dieses Netzes sind dabei 35.887  verschiedene Gesichtsbilder der FER (Facial Expression Recognition) Challenge von Kaggle. Dadurch kann das trainierte Modell eine Genauigkeit in der Emotionsvorhersage von 55,71\% erzielen. die Rate der rcichtig erkannten Pokerfaces zu testen ist jedoch nicht so einfach. Diese kann nur durch ausprobieren festgestellt werden. Die Erkennung eine Pokerfaces wird davon jedoch kaum beeinträchtigt, weshalb das Ziel ein Pokerface zu erkennen nicht verfehlt wurde.
...
\begin{appendix}
\renewcommand\thefigure{{Appendix}.\alph{figure}}
\renewcommand\thetable{{Appendix}.\Roman{table}}
\renewcommand\thelstlisting{{Appendix}.\arabic{lstlisting}}
